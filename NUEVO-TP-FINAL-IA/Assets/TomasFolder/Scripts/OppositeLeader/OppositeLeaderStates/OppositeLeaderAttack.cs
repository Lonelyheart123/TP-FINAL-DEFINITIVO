...
{
    public class OppositeLeaderAttack<T> : State<T>
    {
        OppositeLeaderModel _enemy;
        OppositeLeaderController _enemyController;
        PathfindingEnemyModel _opponent;
        float _distance = 0;
        float time = 0.5f;
        float _counter = 0;
        Vector3 _dir;
        ...
        public OppositeLeaderAttack(OppositeLeaderModel enemyModel, OppositeLeaderController enemyController, PathfindingEnemyModel oppositeLeader, float distance, Vector3 dir, ITreeNode root)
        {
            _enemy = enemyModel;
